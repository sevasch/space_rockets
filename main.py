...
if __name__ == '__main__':
    ...
    s.add_entity(Planet(position_init=Vector(0, 555), radius=500, density=5, color=(0, 255, 0),
                        athmosphere_radius=550, athmosphere_density=1, athmosphere_color=(100, 100, 255), max_wind=0))
    s.add_entity(Planet(position_init=Vector(0, -555), radius=300, density=6, color=(0, 100, 255),
                        athmosphere_radius=360, athmosphere_density=1, athmosphere_color=(200, 200, 255), max_wind=50))
