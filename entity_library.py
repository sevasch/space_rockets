...
class Rocket(EntityBase):
    def __init__(self, position_init: Vector=Vector(), orientation_init=0,
        ...
        self.components.append(RocketBody(self, position_in_entity=Vector(0, 0), orientation_in_entity=0,
                                          ...
                                          lift_coeff=0.8, drag_coeff=0.5, lift_area=height * diameter, drag_area=np.pi * diameter**2 / 4,
                                          color=color))
        ...
        self.components.append(Mass(self, position_in_entity=Vector(0, height*(1-rel_height_pressure_center-0.2)), mass=mass/10*6, moment_of_inertia=0))